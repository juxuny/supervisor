...
#openssl req -newkey rsa:4096 -nodes -keyout client-key.pem -out client-req.pem -subj "/C=CN/ST=Guangdong/L=Dongguan/O=Client/OU=Client/CN=*.juxuny.com/emailAddress=juxuny@163.com"
#
